...
public class KakaoLoginController {
  ...
  @Operation(summary = "엑세스 토큰 발급 및 유저 생성 (자동 처리 로직)",
      description =
          "https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=681c7dd24caab6868c553a07b27422ed&redirect_uri=https://capstone.hyunn.site/api/login/oauth2/code/kakao에서 로그인 후"
